...
Route::get('/tecnico/inicio', [TecnicoController::class, 'index'])->middleware(['checklogin', 'role:tecnico'])->name('tecnico.inicio'); 
Route::post('/tecnico/incidencia/actualizar/{id}', [TecnicoController::class, 'actualizarEstado'])->middleware(['checklogin', 'role:tecnico'])->name('tecnico.incidencia.actualizar');
