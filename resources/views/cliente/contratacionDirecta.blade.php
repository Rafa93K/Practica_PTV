...
<head>
    ...
    <title>Contratar {{ $tarifa->nombre }} - Telecomanager</title>
    ...
    <main class="flex-1 container mx-auto px-4 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="mb-12 text-center">
                ...
                <p class="text-gray-500 text-lg">Completa tus datos para crear tu cuenta y contratar la tarifa
                    <strong>{{ $tarifa->nombre }}</strong></p>
            </div>
            ...
            <form action="{{ route('cliente.contratarDirecta.store') }}" method="POST"
                ...
                <div class="lg:col-span-2 space-y-8">
                    <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="nombre" value="{{ old('nombre') }}" required
                                    class="w-full px-4 py-3 bg-gray-50 border border-transparent rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all outline-none"
                        ...
                        <div class="mt-6 space-y-2">
                            ...
                            <p class="text-xs text-gray-400 ml-1">La usarás para acceder a tu panel de cliente más
                                tarde.</p>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-8 space-y-6">
                        <div class="bg-blue-900 text-white p-8 rounded-[2rem] shadow-xl">
                            <h4 class="text-blue-300 uppercase tracking-widest text-xs font-black mb-6">Resumen del
                                pedido</h4>
                            ...
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <p class="text-yellow-600 font-bold italic">
                                        {{ $tarifa->permanencia == 1 ? "PERMANENCIA DE 1 AÑO" : "" }}</p>
                            ...
                            <button type="submit"
                                class="w-full py-5 bg-white text-blue-900 font-black rounded-2xl hover:bg-blue-50 transition-all active:scale-[0.98] shadow-lg">
                                CONTRATAR AHORA
                            </button>
                        </div>

                        <div class="p-6 bg-white rounded-2xl border border-gray-100 text-center">
                            <p class="text-gray-400 text-xs font-medium">¿Ya tienes cuenta? <a
                                    href="{{ route('login', 'cliente') }}"
                                    class="text-blue-600 font-bold hover:underline">Inicia sesión</a></p>
                        </div>
                    </div>
                </div>
            </form>
